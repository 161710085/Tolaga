  ...
  <div class="card-deck m-b-30">
    <div class="card">
      ...
      <h2 class="card-heading">
        <center>TABEL DATA BERITA</center>
      </h2>
      <h5 class="card-header">
        <div class="col-20">
          ...
          <!-- <a class="btn btn-primary btn-rounded btn-floating btn-outline" href="{{ url('/admin/export/berita') }}">Export</a> -->                   
        </div>
      </h5>
      <div class="card-body">
